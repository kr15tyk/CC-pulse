...
.pacman-dots {
  ...
  gap: 18px;
  padding-left: 8px;
  animation: dotsScroll 12s linear infinite;
}
.pdot {
  ...
  flex-shrink: 0;
  animation: dotEat 12s linear infinite;
}
...
.pacman-char {
  ...
  top: 50%; left: -40px;
  transform: translateY(-50%);
  animation: pacMove 12s linear infinite;
}
.pacman-char svg {
...
.ghost-1 { animation-delay: -1.65s; }
.ghost-2 { animation-delay: -3.3s;  }
.ghost-3 { animation-delay: -4.95s; }
</style>
</head>
<body>
